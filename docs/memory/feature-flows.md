...
|------|-----|---------|------|
| 2026-07-11 | PKG-001 | Immutable admin-owned platform package registry; templates select exact package ID + SHA-256 and receive fixed-destination Docker named-volume mounts with `RW=false` across create, deploy-local, start, and recreation. | [platform-packages.md](feature-flows/platform-packages.md) |
